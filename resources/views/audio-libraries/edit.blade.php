        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('audio-libraries.update', $audioLibrary) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $audioLibrary->title) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ basename($audioLibrary->file_path) }}</p>
                            </div>

                            <label for="audio_file" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                Ganti File Audio (Opsional)
                            </label>
                            ...
                            @error('audio_file')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Format yang didukung: MP3, WAV (maksimal 10MB). Kosongkan jika tidak ingin mengganti file.</p>
                        </div>
